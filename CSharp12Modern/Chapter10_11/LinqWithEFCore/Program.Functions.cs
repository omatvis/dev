...
using System.Linq;
using LinqWithEFCore.EntityModels; // To use NorthwindDb, Category, Product.
...
namespace LinqWithEFCore
{
    public partial class Program
    {
        private static void FilterAndSort()
        {
            ...
            IOrderedQueryable<Product> sortedAndFilteredProducts = allProducts
        ...
        private static void GroupJoinCategoriesAndProducts()
        {
            ...
            // Group join every product to its category to return 8 matches.
            var queryGroupJoin = categories.AsEnumerable().GroupJoin(
                inner: products,
                outerKeySelector: category => category.CategoryId,
                innerKeySelector: product => product.CategoryId,
