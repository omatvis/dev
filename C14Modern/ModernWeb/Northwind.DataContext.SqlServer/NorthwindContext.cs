...
public partial class NorthwindContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        if (!optionsBuilder.IsConfigured)
        {
            ...
            // temporary build connection string for testing purposes, will be removed in production
            // better is to create factory and inject the connection string into the context, but this is a quick way to get it working for now
            ...
            optionsBuilder.UseSqlServer(connectionString?.Replace("{DB_PASSWORD}", dbPwd));
            optionsBuilder.LogTo(NorthwindContextLogger.WriteLog,
