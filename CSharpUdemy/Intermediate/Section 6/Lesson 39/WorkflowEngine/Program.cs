internal class Program
{
    ...
    private static void Main(string[] args)
    {
        ...
        workflow.RegisterActivity(new UploadVideoActivity("video"));
        workflow.RegisterActivity(new WebServiceEncodingActivity("video"));
        workflow.RegisterActivity(new EmailActivity("Email message body"));
        workflow.RegisterActivity(new VideoStatusActivity("Email message body"));
