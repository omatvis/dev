...
public class Person : object, IComparable<Person?>
{
    ...
    public int CompareTo(Person? other)
    {
        ...
        if ((this is not null) && (other is not null))
        {
            ...
            {
                position = -1;
                // else this Person precedes other Person
            }
            else if ((Name is null) && (other.Name is not null))
            {
                position = 1;
                // else this Person follows other Person
            }
            else
            {
                position = 0;
                // this Person and other Person are at same position
            }
        }
        else if ((this is not null) && (other is null))
        {
            position = -1;
            // this Person precedes other Person
        }
